package finalmelontoken.sharestudying.filter;

import finalmelontoken.sharestudying.utils.JwtTokenProvider;
import finalmelontoken.sharestudying.exception.GlobalException;
...
//                handleInvalidTokenException((HttpServletResponse) response, e);
                throw new GlobalException(HttpStatus.UNAUTHORIZED , "인증 자격 없음");
            }
        }
